...
python -m spy_trump_model fetch-gdelt-news --out data/raw/news.csv --max-records 100 --fetch-article-text --max-article-fetches 50 --article-max-age-days 30 --sleep-seconds 4 --article-sleep-seconds 2

# 可选：自定义新闻查询；label=query 可以重复传
python -m spy_trump_model fetch-gdelt-news --out data/raw/news.csv --fetch-article-text --max-article-fetches 30 --article-max-age-days 30 --sleep-seconds 4 --query 'tariffs="Donald Trump" tariffs' --query 'oil="Donald Trump" oil energy'
